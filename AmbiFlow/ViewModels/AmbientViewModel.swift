...
class AmbientViewModel: ObservableObject {
    ...
    private func scheduleNextMelodyNote() {
        ...
        let calculatedInterval = (Double(parameters.melodyIntervalDelay) * baseRhythmMultiplier) + Double(microDelay)
    ...
    func saveCurrentScene(named name: String) {
        ...
        currentSoundscapeName = cleanedName
